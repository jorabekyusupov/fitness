...
if ($connect) {
    ...
    $contact= [];
    $db3query = $db->query("SELECT * FROM settings");
                        ...
                        <div class="col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Settings</h4><strong>|</strong> <a href="./settings_create.php"><div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Settings add</div></a>
                                </div>
                                        ...
                                        <table class="table table-bordered table-md">
                                            ...
                                            if (isset($contact)) {
                                                foreach ($contact as $key => $contacts) {
                                                    ...
                                                    <tr>
                                                        <th scope="row"><?= ++$key ?></th>
                                                        <td> <?=substr($contacts->name, 0, 30)?></td>
                                                        <td ><img style="width: 50px; height: 50px; " src=" <?= $contacts->image ?>" alt=""></td>
                                                        <td style="width: 220px ">
                                                            <form  style="display: inline;" method="POST" action="./settings_Edit.php">
                                                                <input hidden type="hidden" name="id" value="<?= $contacts->id ?>">
                                                                <button class="btn btn-icon icon-left btn-primary" type="submit" ><i class="far fa-edit"></i>Edit</button>
                                                            </form>
                                                            <form  style="display: inline;" method="POST"  action="./php/settingDelete.php">
                                                                <input hidden type="hiddin" name="id" value="<?=$contacts->id?>">
