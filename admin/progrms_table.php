...
if ($connect) {
    ...
    $card= [];
    $db3query = $db->query("SELECT * FROM club_cards");
                        ...
                        <div class="col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Club Cards</h4><strong>|</strong> <a href="../admin/Club_cards.php"><div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Club cards  add</div></a>
                                </div>
                                                ...
                                                foreach ($card as $key => $cards) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 220px ">
                                                            ...
                                                            <form  style="display: inline;" method="POST"  action="./php/clubcarDelete.php">
                                                                <input hidden type="hiddin" name="id" value="<?=$cards->id?>">
