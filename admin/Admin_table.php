                                ...
                                <div class="card-body">
                                    <table  class="table ">
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color:   rgba(0,0,0,0.04); ">Status</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php foreach ($user as $key => $users): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div style=" padding: 5px 15px 5px 15px; " class="btn btn-success" class="badge  <?= ($users->status == 1) ? 'badge-success' : 'badge-danger' ?> badge-shadow"><?= ($users->status == 1) ? 'Active' : 'Active' ?></div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
