              ...
              <div class="col-12 ">
                <div class="card">
                  <div class="card-header">
                      <h4>Sports type</h4><strong>|</strong> <a href="../admin/create_sport.php"><div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Sport type add</div></a>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        <tr>
                          ...
                          <?php foreach ($trainers as $key =>$trainers_new) : ?>
                              <tr>
                                  <th scope="row"><?= ++$key ?></th>
                                  <td><?=$trainers_new->Sport_name?></td>
                                  <td>
                                      <div style=" padding: 8px 10px 8px 10px; border-radius: 30px; ";   class="badge  <?= ($trainers_new->status == 1) ? 'badge-success' : 'badge-danger' ?> badge-shadow"><?= ($trainers_new->status == 1) ? 'Active' : 'deactive' ?></div>
                                  </td>
                                  <td style="width: 220px ">
                                      <form  style="display: inline;" method="POST" action="./edit_sport.php">
                                          <input hidden type="hidden" name="id" value="<?=$trainers_new->id?>">
<!--                                          <a  class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Edit</a>-->
                                          <button class="btn btn-icon icon-left btn-primary"  type="submit" ><i class="far fa-edit"></i>Edit</button>
                                      </form>
                                      <form  style="display: inline;" method="POST"  action="./php/sportDelet.php">
                                          <input hidden type="hiddin" name="id" value="<?= $trainers_new->id?>">
<!--                                          <a  class="btn btn-icon icon-left btn-danger"><i class="fas fa-times"></i> Delete</a>-->
