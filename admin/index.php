        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li >
              ...
              <li class="dropdown">
                  <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="sliders"></i><span>Settings</span></a>
                  <ul class="dropdown-menu">
                      <li><a class="nav-link"  href="settinges.php">Logo</a></li>
                      <li><a class="nav-link" href="./club_table.php">Club_card</a></li>
                      <li><a class="nav-link" href="./">Our_programs</a></li>

                  </ul>
              </li>

              <li >
                  <a href="about_table.php"  ><i
                              data-feather="pie-chart"></i><span>About_Company</span></a>
                              ...
                              <table class="table table-hover mb-0">
                                  ...
                                  <?php foreach ($help as $key => $users): ?>
                                      <tr>
                                          ...
                                          <td>  <?= substr($users->bodytext, 0, 20) ?></td>
                                          <td><a href="#" class="btn btn-outline-primary">Detail</a></td>
