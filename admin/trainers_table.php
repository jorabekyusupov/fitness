                        ...
                        <div class="col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Trainers</h4><strong>|</strong> <a href="../admin/create_triner.php"><div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Trainer add</div></a>
                                </div>
                                            ...
                                            if (isset($work)) {
                                                foreach ($work as $key => $works) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td ><img style="width: 30px; height: 30px; border-radius: 50%;" src=" <?= $works->image ?>" alt=""></td>
                                                        <td><?= $works->price ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style=" padding: 8px 10px 8px 10px; border-radius: 30px; "  class="badge  <?= ($works->status == 1) ? 'badge-success' : 'badge-danger' ?> badge-shadow"><?= ($works->status == 1) ? 'Active' : 'deactive' ?></div>
                                                        </td>
                                                        <td style="width: 220px ">
                                                            <form  style="display: inline;" method="POST" action="./edit_triner.php">
                                                                <input hidden type="hidden" name="id" value="<?= $works->id ?>">
                                                                <button class="btn btn-icon icon-left btn-primary" type="submit" ><i class="far fa-edit"></i>Edit</button>
                                                            </form>
                                                            <form  style="display: inline;" method="POST"  action="./php/trainerdelete.php">
                                                                <input hidden type="hiddin" name="id" value="<?=$works->id?>">
