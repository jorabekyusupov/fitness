...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $open = $db->query("select * from categories where id =$id");
        if ($open->num_rows > 0) {
            while ($queryAll = $open->fetch_object()) {
                $old[] = $queryAll;
            }
        }
        $cate3 = $db->query("select id , Sport_name from categories where status = 1");
        if ($cate3->num_rows > 0) {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form style="border: none" class="form-control" method="POST" action="/php/sportUpdate.php">
                                        <input type="hidden" class="form-control" name="id" value="<?= $arry->id ?? ' ' ?>">

                                        <div class="form-group m-2 ">
                                            <label >Sport name</label>
                                            <div >
                                                <input type="text"  class="form-control" id="Sport_name" name="Sport_name"  value="<?= $arry->Sport_name ?? ''?>">
                                            </div>
                                        </div>
