...
if ($connect) {
    ...
    $query12 = $db->query("SELECT * FROM categories");

    if ($query12->num_rows > 0) {
        while ($queryAll = $query12->fetch_object()) {
            $works_new[] = $queryAll;
        }
    }
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="m-5" action="./php/trainercreate.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text"  class="form-control" id="create_time" name="create_time" value="<?php echo date("Y-m-d h:i:s"); ?>" placeholder="UpdateDate">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <select class="form-control selectric" name="category_id">
                                                    <?php foreach ($works_new as $item) { ?>
                                                        <option value="<?= $item->id ?>"><?= $item->Sport_name ?></option>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <textarea   type="text" name="bodytext" class="summernote-simple"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
