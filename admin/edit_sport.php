...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $sports_edit = $db->query("select * from categories where id = $id");
        ...
        $agree = $db->query("select id,Sport_name from categories where status = 1");
        if ($agree->num_rows > 0) {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="m-5" action="./php/sportUpdate.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" name="id" value="<?=$result->id ?? ' ' ?>">
                                    <div class="form-group m-2 ">
                                            <label >Sport name</label>
                                            <div >
                                                <input type="text"  class="form-control" id="Sport_name" value="<?=$result->Sport_name ?? ''?>" name="Sport_name" placeholder="Enter Sport_name">
                                            </div>
                                        </div>
