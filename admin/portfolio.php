...
if ($connect) {
    ...
    $query = $db->query("SELECT * FROM work_new order by id desc limit 6");
...
<!-- portfolio.php  21 Nov 2019 03:50:12 GMT -->
<head>
  <meta charset="UTF-8">
                    ...
                    <div class="bootstrap snippet">
                      <section id="portfolio" class="gray-bg padding-top-bottom">
                        ...
                        <div class="categories">
                          <ul>
                            <li class="active">
                              <a href="#" data-filter="*">Fitmax Gallery</a>
                            </li>
                          </ul>
                        </div>
                        <!-- ======= Portfolio items ===-->
                                      ...
                                      <article class="col-md-4 col-sm-6 portfolio-item web-design apps psd">
                                          <div class="portfolio-thumb in">
                                              <a href="#" class="main-link">
                                                  <img class="img-responsive img-center" style="width: 300px;height: 300px" src="<?= $works->image ?>" alt="">
                                                  <span class="project-title"><?= $cat1->Sport_name ?></span>
...
<!-- portfolio.php  21 Nov 2019 03:50:31 GMT -->
</html>