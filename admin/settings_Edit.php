...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $open = $db->query("select * from settings where id ='$id'");
        if ($open->num_rows > 0) {
            while ($queryAll = $open->fetch_object()) {
                $oldr[] = $queryAll;
            }
        }
        $cate3 = $db->query("select id ,  name, image from settings");
        if ($cate3->num_rows > 0) {
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Settings create</h4>
                                </div>
                                <div class="card-body">
                                    <form class="m-5" action="./php/settingesEdit.php" method="post" enctype="multipart/form-data">
