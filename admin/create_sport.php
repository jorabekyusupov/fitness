                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="m-5" action="./php/sportcreate.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group m-2 ">
                                            <label >Sport name</label>
                                            <div >
                                                <input type="text"  class="form-control" id="Sport_name" name="Sport_name" placeholder="Enter Sport_name">
                                            </div>
                                        </div>
