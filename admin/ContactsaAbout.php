...
if ($connect) {
    ...
    $contact= [];
    $db3query = $db->query("SELECT * FROM contacts2");
                        ...
                        <div class="col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Contacts</h4><strong>|</strong> <a href="./Contacts.php"><div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Contacts add</div></a>
                                </div>
                                            ...
                                            if (isset($contact)) {
                                                foreach ($contact as $key => $contacts) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <?=substr($contacts->email, 0, 30)?></td>
                                                        <td><?= $contacts->address ?></td>

                                                        <td style="width: 220px ">
                                                            <form  style="display: inline;" method="POST" action="./Contactedit.php">
                                                            ...
                                                            <form  style="display: inline;" method="POST"  action="./php/ContactsDelete.php">
