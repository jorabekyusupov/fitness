                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="m-5" action="./php/clubcardCreate.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Secondary Title</label>
                                            <div class="col-sm-12 col-md-7">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <textarea   type="text" name="description" class="summernote-simple"></textarea>
                                            </div>
                                        </div>
