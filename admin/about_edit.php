...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $aboute = $db->query("select * from about_com where id ='$id'");
        if ($aboute->num_rows > 0) {
            while ($queryAll = $aboute->fetch_object()) {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="m-5" action="./php/aboutEdit.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="tel"  name="phone" id=" phone" value="<?= $Company->phone ?? ' ' ?>"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
